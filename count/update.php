        ...
        <div class="scan flex justify-between w-full mt-3">
            ...
            <form action="../app/process.php" method="post">
                ...
                <div class="flex justify-between gap-x-2">
                    ...
                    <button type="button" id="deleteCount" class="grid place-items-center mt-3 py-3 px-3 rounded-full bg-red-600/90 shadow-md shadow-red-400 text-white font-semibold mt-5">
